package com.ilifeeasy.service.test.onetomany;
...
import com.ilifeeasy.dao.test.onetomany.TestDataChild2Dao;
import com.ilifeeasy.dao.test.onetomany.TestDataChild3Dao;
import com.ilifeeasy.dao.test.onetomany.TestDataChildDao;
import com.ilifeeasy.dao.test.onetomany.TestDataMainDao;
import com.ilifeeasy.entity.common.Page;
import com.ilifeeasy.entity.common.StringTools;
import com.ilifeeasy.entity.test.onetomany.TestDataChild;
import com.ilifeeasy.entity.test.onetomany.TestDataChild2;
import com.ilifeeasy.entity.test.onetomany.TestDataChild3;
	...
	public void save(TestDataMain testDataMain) {
		...
		for (TestDataChild testDataChild : testDataMain.getTestDataChildList()){
			...
			if (TestDataChild.DEL_FLAG_NORMAL.equals(testDataChild.getDelFlag())){
				if (StringTools.isBlank(testDataChild.getId())){
		...
		for (TestDataChild2 testDataChild2 : testDataMain.getTestDataChild2List()){
			...
			if (TestDataChild2.DEL_FLAG_NORMAL.equals(testDataChild2.getDelFlag())){
				if (StringTools.isBlank(testDataChild2.getId())){
		...
		for (TestDataChild3 testDataChild3 : testDataMain.getTestDataChild3List()){
			...
			if (TestDataChild3.DEL_FLAG_NORMAL.equals(testDataChild3.getDelFlag())){
				if (StringTools.isBlank(testDataChild3.getId())){//StringUtils
