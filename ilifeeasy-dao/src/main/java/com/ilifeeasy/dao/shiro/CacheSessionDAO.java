package com.ilifeeasy.dao.shiro;
...
import com.ilifeeasy.dao.utils.Servlets;
...
public class CacheSessionDAO extends EnterpriseCacheSessionDAO implements SessionDAO {
	...
	public Collection<Session> getActiveSessions(boolean includeLeave, Object principal, Session filterSession) {
		...
		for (Session session : getActiveSessions()) {
			...
			// 符合登陆者条件。 Andy
			/*
			 * if (principal != null) { PrincipalCollection pc =
			 * (PrincipalCollection) session
			 * .getAttribute(DefaultSubjectContext.PRINCIPALS_SESSION_KEY); if
			 * (principal.toString().equals(pc != null ?
			 * pc.getPrimaryPrincipal().toString() : StringUtils.EMPTY)) {
			 * isActiveSession = true; } }
			 */
			// 过滤掉的SESSION
