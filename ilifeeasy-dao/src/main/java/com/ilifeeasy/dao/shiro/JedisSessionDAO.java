...
import com.ilifeeasy.dao.utils.JedisUtils;
...
public class JedisSessionDAO extends AbstractSessionDAO implements SessionDAO {
	...
	public void update(Session session) throws UnknownSessionException {
		...
		if (request != null) {
			...
			// 如果是视图文件，则不更新SESSION Andy
			/*
			 * if (StringTools.startsWith(uri,
			 * Global.getConfig("web.view.prefix")) && StringTools.endsWith(uri,
			 * Global.getConfig("web.view.suffix"))) { return; }
			 */
			// 手动控制不更新SESSION
