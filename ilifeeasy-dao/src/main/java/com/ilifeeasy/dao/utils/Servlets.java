...
import com.ilifeeasy.entity.common.Encodes;
...
public class Servlets {
	...
	// 静态文件后缀
	private final static String[] staticFiles = StringTools.split(Global.getConfig("web.staticFile"), ",");
	...
	public static boolean isStaticFile(String uri) {
		...
		// return true;
		// }
		// if (StringTools.endsWithAny(uri, staticFiles) &&
		// !StringTools.endsWithAny(uri, urlSuffix)
		// && !StringTools.endsWithAny(uri, ".jsp") &&
		// !StringTools.endsWithAny(uri, ".java")) {
		// return true;
		// }
		return false;
	}
