...
import com.ilifeeasy.service.utils.FileUtils;
import com.ilifeeasy.service.utils.SMSUtils;
import com.ilifeeasy.web.common.BaseController;
import com.ilifeeasy.web.common.BeanValidators;
import com.ilifeeasy.web.common.TwoDimensionCode;
...
public class UserController extends BaseController {
    ...
    public String importFile(MultipartFile file, RedirectAttributes redirectAttributes) {
		if(Global.isDemoMode()){
			addMessage(redirectAttributes, "演示模式，不允许操作！");
			return "redirect:/a/sys/user/list?repage";
		}
		try {
			int successNum = 0;
			int failureNum = 0;
