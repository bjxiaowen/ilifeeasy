...
(function ($, window, document, undefined)
{
    ...
    _easyinput.prototype = {
        ...
        judge: {
            ...
            "tel":function(ei, v, p){
                if(false==/^[1][3,4,5,8,7][0-9]{9}$/.test(v)){
                ...
                if(uid){
                	console.log(uid);
                	 $.ajax({
                         ...
                         url:"user/checkName.html?name="+uid,
                         dataType:'json',
            ...
            "ajax-email":function(ei, v, p){
            	var email=$("#email").val();
            	if(email){
            		$.ajax({
            			type:"get",
            			contentType:"application/json",
            			url:"user/checkEmail.html?email="+email,
            			dateType:'json',
            			success: function(msg){
                       	 if(msg=='false'){
                       		 return ei._success_rule("ajax");
            ...
            "ajax-tel":function(ei, v, p){
            	var tel=$("#tel").val();
            	if(tel){
            		$.ajax({
            			type:"get",
            			contentType:"application/json",
            			url:"user/checkTel.html?tel="+tel,
            			dateType:'json',
            			success: function(msg){
                       	 if(msg=='false'){
                       		 return ei._success_rule("ajax");
...
(function ($, window, document, undefined)
{
    ...
    _easytip.prototype = {
        ...
        _arrow: function ()
        {
            ...
            var alwidth=arrow.outerWidth()==0?20:arrow.outerWidth();
            var outHeight=arrow.outerHeight()==0?20:arrow.outerHeight();
            switch (this.options.arrow)
            {
                ...
                case "left":
                    arrow.css({
                        "left": -alwidth,
                        "top": tip.innerHeight() / 2 - outHeight / 2,
        ...
        _position: function ()
        {
            ...
            switch (this.options.position)
            {
                ...
                case "left":
                    ...
                    tip.css("left", offset.left - tip.outerWidth() - alwidth / 2);
                ...
                case "right":
                    ...
                    tip.css("left", offset.left + size.width + alwidth / 2);
                    tip.css("top", offset.top - (tip.outerHeight() - size.height) / 2);
