...
<head>
<title>
    <title><sitemesh:title/> - Powered By Andy</title>
	<%@include file="/resources/include/head.jsp" %>
	<sitemesh:head/>		
</title>
<sitemesh:write property='head' />
</head>
<body id="<sitemesh:write property='body.id'/>" class="<sitemesh:write property='body.class'/>"  style="<sitemesh:write property='body.style'/>">
