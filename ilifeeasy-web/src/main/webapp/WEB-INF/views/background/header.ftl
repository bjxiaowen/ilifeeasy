...
<div class="header navbar navbar-fixed-top">
	...
	<div class="header-inner">
		...
		<a class="navbar-brand" href="${BasePath}">
			<img src="/resources/images/head/logo.png" alt="logo" class="img-responsive"/>
		</a>
		<!-- END LOGO -->
		<!-- BEGIN RESPONSIVE MENU TOGGLER -->
		<a href="javascript:;" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
			<img src="/resources/images/head/menu-toggler.png" alt=""/>
		</a>
		...
		<ul class="nav navbar-nav pull-right">
			...
			<li class="dropdown user">
				<a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
					<img alt="" src="/resources/images/head/<#if user.gender==true>avatar3_small.jpg<#else>avatar2_small.jpg</#if>"/>
					<span class="username">
