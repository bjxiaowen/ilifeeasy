...
<link rel="stylesheet" type="text/css" href="/resources/css/themes/default.css" rel="stylesheet" type="text/css" id="style_color"/>
...
<!-- BEGIN CORE PLUGINS -->
<!--[if lt IE 9]>
<script src="/resources/js/plugins/respond.min.js"></script>
<script src="/resources/js/plugins/excanvas.min.js"></script> 
<![endif]-->
...
<script src="/resources/js/plugins/additional-methods.min.js"></script>
<!-- END GENERAL PLUGINS -->
