...
<head>
	...
	<script src="/resources/static/common/inspinia.js?v=3.2.0"></script>
	<script src="/resources/static/common/contabs.js"></script> 
    <meta name="keywords" content="Iovov快速开发平台">
    <meta name="description" content="Iovov，采用spring mvc+mybatis+shiro+bootstrap，集成代码生成器的快速开发平台">
...
<body class="fixed-sidebar full-height-layout gray-bg">
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="footer">
                <div class="pull-left"><a href="http://www.Iovov.org">http://www.Iovov.org</a> &copy; 2015-2025</div>
            </div>
        </div>
        <!--右侧部分结束-->
    </div>
...
<!-- 即时聊天插件 -->
<link href="/resources/static/layer-v2.0/layim/layim.css" type="text/css" rel="stylesheet"/>
<script type="text/javascript">
...
<script src="/resources/static/layer-v2.0/layim/layer.min.js"></script>
<script src="/resources/static/layer-v2.0/layim/layim.js"></script>
</html>