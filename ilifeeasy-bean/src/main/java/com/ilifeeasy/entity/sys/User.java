package com.ilifeeasy.entity.sys;
...
import com.ilifeeasy.entity.annotation.ExcelField;
import com.ilifeeasy.entity.annotation.SupCol;
import com.ilifeeasy.entity.common.Collections3;
...
public class User extends DataEntity<User> {
	...
	public String toString() {
		return "User [company=" + company + ", office=" + office + ", loginName=" + loginName + ", password=" + password
				...
				+ loginFlag + ", photo=" + photo + ", qrCode=" + qrCode + ", oldLoginName=" + oldLoginName
